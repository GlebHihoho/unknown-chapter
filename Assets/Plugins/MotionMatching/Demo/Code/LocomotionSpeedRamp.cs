...
public class LocomotionSpeedRamp : MonoBehaviour
{
    ...
    [SerializeField] private string m_walkSpeedTagName = "Walk";
    ...
    private void Start()
    {
        ...
        m_walkTagHandle = m_mxmAnimator.CurrentAnimData.FavourTagFromName(m_walkSpeedTagName);
